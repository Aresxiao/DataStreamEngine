...
import timingservice.message.AuthMsg;
import timingservice.message.Message;
import timingservice.message.ResponseTimeMsg;
...
public class PCHost
{
	...
	private final Map<String, Socket> device_hostsocket_map = new HashMap<String, Socket>();
	...
	private Message waitForRequestTimeMsg(final Socket host_socket)
	{
		...
		return msg;		//	will have some error
	}
...
//				System.out.println("Receiving RequestTimeMsg: " + msg.toString());
	...
	{
		ADBExecutor adb_executor = new ADBExecutor("C:\\Program Files (x86)\\Android\\android-sdk\\platform-tools\\adb.exe ");
